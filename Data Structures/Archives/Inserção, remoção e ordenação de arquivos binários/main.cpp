...
*********************************************************************************************************************************
				   ...
				   |______\__, |_| .__/ \___|_|\___/|___/   \/|_|\/   |_| \_|\___/|_|  \__,_|_|\___\___/|___/
						   ...
						   |___|
									...
									Arquivo arquivo principal, que contém a função main() e faz a chamada dos métodos
...
int main() {
	arquivo arquivoDeus;   // Constrói um objeto arquivo e chama o metodo menu(), onde ocorrem todas operacoes do programa
	arquivoDeus.menu();
	return 0;
}
